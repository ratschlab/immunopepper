...
# Concatenate my condition2 with the kmers
...
#Check condition 2. If there is any kmer with expression bigger than 100 we select it as cancer
...
path_results_sample_cancer= '../../../immunopepper_usecase/filter_case/condition2/part-00000-a4c9cf82-ad78-41d0-80c2-2a5f48a0069c-c000.csv.gz'
...
#TODO: check why this is not being fulfilled
...
#I will do the intersection between kmers_cond3 and condition2_kmers
...
df_normal = pd.merge(df_normal_cond1, df_normal_cond2, how='outer', on=['kmer'])

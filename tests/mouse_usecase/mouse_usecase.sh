...
immunopepper build --samples ENCSR000BZG ERR2130621 --output_dir immunopepper_usecase_out --splice_path immunopepper_usecase.pickle --ann_path immunopepper_usecase.gtf --ref_path genome1.fa --kmer 9 --count_path immunopepper_usecase.count.hdf5
immunopepper build --samples ENCSR000BZG ERR2130621 --output_dir immunopepper_usecase_out --splice_path immunopepper_usecase.pickle --ann_path immunopepper_usecase.gtf --ref_path genome1.fa --kmer 9 --count_path immunopepper_usecase.count.hdf5 --vcf_path immunopepper_usecase.vcf --maf_path immunopepper_usecase.maf
immunopepper build --samples ENCSR000BZG ERR2130621 --output_dir immunopepper_usecase_out --splice_path immunopepper_usecase.pickle --ann_path immunopepper_usecase.gtf --ref_path genome1.fa --kmer 9 --count_path immunopepper_usecase.count.hdf5 --vcf_path immunopepper_usecase.vcf --maf_path immunopepper_usecase.maf
immunopepper build --samples ENCSR000BZG ERR2130621 --output_dir immunopepper_usecase_out --splice_path immunopepper_usecase.pickle --ann_path immunopepper_usecase.gtf --ref_path genome1.fa --kmer 9 --count_path immunopepper_usecase.count.hdf5 --vcf_path immunopepper_usecase.vcf --maf_path immunopepper_usecase.maf

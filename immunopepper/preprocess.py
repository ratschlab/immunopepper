...
def search_edge_metadata_segmentgraph(gene, coord, countinfo, Idx, edge_idxs=None, edge_counts=None):
    ...
    countinfo: NamedTuple, conatins SplAdder count info
    ...
    """
    def get_segmentgraph_edge_expr(sorted_pos, countinfo, edge_idxs, edge_counts=None):
        ...
        if edge_counts is None:
            return countinfo.h5f['edges'][edge_gene_idxs[cidx], Idx.sample]
        else:
    ...
    if edge_idxs is None or edge_counts is None:
        ...
        count = get_segmentgraph_edge_expr(sorted_pos, countinfo, edge_idxs)
    else:
        count = get_segmentgraph_edge_expr(sorted_pos, countinfo, edge_idxs, edge_counts) 
    ...
    if coord.start_v3 is None:
        ...
        if edge_idxs is None or edge_counts is None:
            count2 = get_segmentgraph_edge_expr(sorted_pos, countinfo, edge_idxs)
        else:
            count2 = get_segmentgraph_edge_expr(sorted_pos, countinfo, edge_idxs, edge_counts)
        return (count, count2)

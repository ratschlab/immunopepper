...
def get_cancerspecif_parser(parser):
    ...
    inputs.add_argument("--path-cancer-libsize", help="Path for the libsize file of the selected cancer samples. It corresponds to the output 7 of :ref:`build output section <build_out>`", required=False, default=None)
    inputs.add_argument("--path-normal-libsize", help="Path for the libsize of the selected normal samples. It corresponds to the output 7 of :ref:`build output section <build_out>`", required=False, default=None)
    ...
    nrf.add_argument("--path-normal-matrix-segm", nargs='+', help="Path to the matrix of segment expression of kmers in normal samples. This corresponds to output 5 of :ref:`build output section <build_out>`", required=False, default=None)
    nrf.add_argument("--path-normal-matrix-edge", nargs='+', help="Path to the matrix of junction expression of kmers in normal samples. This corresponds to output 6 of :ref:`build output section <build_out>`", required=False, default=None)

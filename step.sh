...
#STAR --runThreadN 3 --runMode genomeGenerate --genomeDir ${test_data_dir}/data/genome/pos --genomeFastaFiles ${test_data_dir}/data/${testname}pos.fa --sjdbGTFfile ${test_data_dir}/data/${testname}pos.gtf --sjdbOverhang 14 --sjdbInsertSave Basic
#STAR --runThreadN 3 --runMode genomeGenerate --genomeDir ${test_data_dir}/data/genome/neg --genomeFastaFiles ${test_data_dir}/data/${testname}neg.fa --sjdbGTFfile ${test_data_dir}/data/${testname}neg.gtf --sjdbOverhang 14 --sjdbInsertSave Basic
...
# positive case
#python ${script_dir}/main_immuno.py --mutation_mode ref --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}pos --debug --vcf_path ${test_data_dir}/data/${testname}pos.vcf --maf_path ${test_data_dir}/data/${testname}pos.maf
#python ${script_dir}/main_immuno.py --mutation_mode somatic --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}pos --debug --vcf_path ${test_data_dir}/data/${testname}pos.vcf --maf_path ${test_data_dir}/data/${testname}pos.maf
#python ${script_dir}/main_immuno.py --mutation_mode germline --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}pos --debug --vcf_path ${test_data_dir}/data/${testname}pos.vcf --maf_path ${test_data_dir}/data/${testname}pos.maf
#python ${script_dir}/main_immuno.py --mutation_mode somatic_and_germline --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}pos --debug --vcf_path ${test_data_dir}/data/${testname}pos.vcf --maf_path ${test_data_dir}/data/${testname}pos.maf

# negative case
#python ${script_dir}/main_immuno.py --mutation_mode ref --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}neg --debug --vcf_path ${test_data_dir}/data/${testname}neg.vcf --maf_path ${test_data_dir}/data/${testname}neg.maf
#python ${script_dir}/main_immuno.py --mutation_mode somatic --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}neg --debug --vcf_path ${test_data_dir}/data/${testname}neg.vcf --maf_path ${test_data_dir}/data/${testname}neg.maf
#python ${script_dir}/main_immuno.py --mutation_mode germline --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/${testname}neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/${testname}neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples ${testname}neg --debug --vcf_path ${test_data_dir}/data/${testname}neg.vcf --maf_path ${test_data_dir}/data/${testname}neg.maf

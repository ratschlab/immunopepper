...
#mkdir ${test_data_dir}/data/genome
...
#mkdir ${test_data_dir}/data/align
...
#python ${script_dir}/main_immuno.py --output_dir tests --ann_path ${test_data_dir}/data/test1.gtf --splice_graph ${test_data_dir}/data/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1.fa --count_path ${test_data_dir}/data/spladder/genes_graph_conf3.merge_graphs.count.hdf5

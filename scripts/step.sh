...
# positive case
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1pos --debug --vcf_path ${test_data_dir}/data/test1pos.vcf --maf_path ${test_data_dir}/data/test1pos.maf
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1pos --debug --vcf_path ${test_data_dir}/data/test1pos.vcf --maf_path ${test_data_dir}/data/test1pos.maf
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1pos --debug --vcf_path ${test_data_dir}/data/test1pos.vcf --maf_path ${test_data_dir}/data/test1pos.maf
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1pos.gtf --splice_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1pos.fa --count_path ${test_data_dir}/data/posgraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1pos --debug --vcf_path ${test_data_dir}/data/test1pos.vcf --maf_path ${test_data_dir}/data/test1pos.maf

# negative case
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1neg --debug --vcf_path ${test_data_dir}/data/test1neg.vcf --maf_path ${test_data_dir}/data/test1neg.maf
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1neg --debug --vcf_path ${test_data_dir}/data/test1neg.vcf --maf_path ${test_data_dir}/data/test1neg.maf
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1neg --debug --vcf_path ${test_data_dir}/data/test1neg.vcf --maf_path ${test_data_dir}/data/test1neg.maf
python ${script_dir}/main_immuno.py --output_dir ${test_data_dir} --ann_path ${test_data_dir}/data/test1neg.gtf --splice_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.pickle --ref_path ${test_data_dir}/data/test1neg.fa --count_path ${test_data_dir}/data/neggraph/spladder/genes_graph_conf3.merge_graphs.count.hdf5 --samples test1neg --debug --vcf_path ${test_data_dir}/data/test1neg.vcf --maf_path ${test_data_dir}/data/test1neg.maf
